...
function cMeleeRatio(attacker, defender, params, ignoredDef)
    ...
    if (weaponType == dsp.skill.HAND_TO_HAND) then
        ratiocap = 3.5
    elseif (weaponType == dsp.skill.GREAT_SWORD or weaponType == dsp.skill.GREAT_AXE or weaponType == dsp.skill.SCYTHE or weaponType == dsp.skill.POLEARM or weaponType == dsp.skill.GREAT_KATANA or weaponType == dsp.skill.STAFF) then
        ratiocap = 3.75
    end
    ...
    local pdifcrit = {}
    cratio = cratio + 1
    cratio = utils.clamp(cratio, 0, ratiocap + 1)
...
function cRangedRatio(attacker, defender, params, ignoredDef)
    ...
    local weaponType = attacker:getWeaponSkillType(dsp.slot.AMMO)
    local ratiocap = 3.25
    if (weaponType == dsp.skill.MARKSMANSHIP) then
        ratiocap = 3.5
    end
