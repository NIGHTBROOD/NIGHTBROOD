...
dsp.aftermath.effects =
{
    ...
    [21] = { mods = { dsp.mod.HASTE_GEAR, 1000, dsp.mod.ACC, 15 }, duration = getTier2RelicDuration }, -- Apocalypse
    ...
    [33] = -- Gastraphetes, Death Penalty
    {
        mods = { { dsp.mod.RACC, function(tp) return math.floor(tp / 100) end },
                 ...
                 { dsp.mod.REM_OCC_DO_DOUBLE_DMG_RANGED, function(tp) return 400 end } },
        duration = { 60, 90, 120 }
    },
