...
function onInitialize(zone)
    ...
    GetMobByID(ID.mob.VRTRA):setRespawnTime(math.random(300, 3600)); -- math.random(86400, 259200)

    UpdateNMSpawnPoint(ID.mob.BARBASTELLE);
    GetMobByID(ID.mob.BARBASTELLE):setRespawnTime(math.random(300, 3600)); -- math.random(1800,5400)
