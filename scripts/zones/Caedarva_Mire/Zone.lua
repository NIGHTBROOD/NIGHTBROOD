...
function onInitialize(zone)
    ...
    GetMobByID(ID.mob.AYNU_KAYSEY):setRespawnTime(math.random(300, 3600));
    GetMobByID(ID.mob.KHIMAIRA):setRespawnTime(math.random(300, 3600)); -- 12 to 36 hours after maintenance, in 1-hour increments math.random(12,36)*3600
