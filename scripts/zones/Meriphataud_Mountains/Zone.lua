...
function onInitialize(zone)
    ...
    GetMobByID(ID.mob.WARAXE_BEAK):setRespawnTime(math.random(300, 3600)) -- math.random(900, 10800)

    UpdateNMSpawnPoint(ID.mob.COO_KEJA_THE_UNSEEN)
    GetMobByID(ID.mob.COO_KEJA_THE_UNSEEN):setRespawnTime(math.random(300, 3600)) -- math.random(900, 10800)
