...
function onInitialize(zone)
    ...
    GetMobByID(ID.mob.OLD_TWO_WINGS):setRespawnTime(math.random(300, 3600)); --math.random(900, 10800)

    UpdateNMSpawnPoint(ID.mob.SKEWER_SAM);
    GetMobByID(ID.mob.SKEWER_SAM):setRespawnTime(math.random(300, 3600)); -- math.random(900, 10800)

    UpdateNMSpawnPoint(ID.mob.SERKET);
    GetMobByID(ID.mob.SERKET):setRespawnTime(math.random(300, 3600)); -- math.random(900, 10800)
