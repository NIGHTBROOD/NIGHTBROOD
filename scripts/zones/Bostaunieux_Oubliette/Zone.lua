...
function onInitialize(zone)
    ...
    GetMobByID(ID.mob.DREXERION_THE_CONDEMNED):setRespawnTime(math.random(300, 3600)) -- math.random(900, 10800)

    UpdateNMSpawnPoint(ID.mob.PHANDURON_THE_CONDEMNED)
    GetMobByID(ID.mob.PHANDURON_THE_CONDEMNED):setRespawnTime(math.random(300, 3600)) -- math.random(900, 10800)
