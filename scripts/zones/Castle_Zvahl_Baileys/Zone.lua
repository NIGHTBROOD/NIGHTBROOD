...
function onInitialize(zone)
    ...
    GetMobByID(ID.mob.LIKHO):setRespawnTime(math.random(300, 3600)) -- math.random(3600, 4200)

    UpdateNMSpawnPoint(ID.mob.MARQUIS_ALLOCEN)
    GetMobByID(ID.mob.MARQUIS_ALLOCEN):setRespawnTime(math.random(300, 3600)) -- math.random(900, 10800)

    UpdateNMSpawnPoint(ID.mob.MARQUIS_AMON)
    GetMobByID(ID.mob.MARQUIS_AMON):setRespawnTime(math.random(300, 3600)) -- math.random(900, 10800)

    UpdateNMSpawnPoint(ID.mob.DUKE_HABORYM)
    GetMobByID(ID.mob.DUKE_HABORYM):setRespawnTime(math.random(300, 3600)) -- math.random(900, 10800)

    UpdateNMSpawnPoint(ID.mob.GRAND_DUKE_BATYM)
    GetMobByID(ID.mob.GRAND_DUKE_BATYM):setRespawnTime(math.random(300, 3600)) -- math.random(900, 10800)
